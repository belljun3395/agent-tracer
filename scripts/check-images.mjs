// 빌드가 성공해도 못 뜨는 이미지가 있으므로 여덟을 빌드하고 실행에 필요한 것을 담았는지 확인한다.
//
...
const SERVER_APPS = ["runtime-api", "tracer-api", "chat-agent-worker", "projector", "ai-agent-worker"];
