...
// src/agent/claude-code/payload/workspace.payload.ts
function readUserPromptExpansion(raw) {
...
var EXPANSION_TITLE_MAX = 200;
var EXPANSION_SNIPPET_MAX = 2e3;
function promptExpansionEvent(target, input) {
  const expanded = input.expandedPrompt ?? "";
  const snippet = expanded.length > EXPANSION_SNIPPET_MAX ? `${truncate(expanded, EXPANSION_SNIPPET_MAX)}\u2026` : expanded;
  ...
  const metadata = {
    ...
    ...input.commandArgs !== void 0 ? { commandArgs: input.commandArgs } : {},
    ...input.commandSource !== void 0 ? { commandSource: input.commandSource } : {},
...
// src/agent/claude-code/hooks/UserPromptExpansion.ts
  ...
  handler: async (payload) => {
    ...
    await onLifecycleEvent(claudeRuntime.ingest, [
      promptExpansionEvent(target, {
        ...
        ...payload.commandArgs !== void 0 ? { commandArgs: payload.commandArgs } : {},
        ...payload.commandSource !== void 0 ? { commandSource: payload.commandSource } : {},
        ...payload.prompt !== void 0 ? { expandedPrompt: payload.prompt } : {}
      })
    ]);
  }
});
