...
function cwdChangedEvent(target, oldCwd, newCwd) {
  const body = oldCwd && newCwd ? `${oldCwd} \u2192 ${newCwd}` : newCwd ? `cwd set to ${newCwd}` : "cwd changed";
...
// src/agent/claude-code/hooks/CwdChanged.ts
