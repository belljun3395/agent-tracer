...
// src/agent/claude-code/payload/agent.payload.ts
function readSubagent(raw) {
...
// src/domain/binding/inbound/binding.hook.ts
function onBindingLookup(hook, runtimeSource, runtimeSessionId) {
...
var LAST_MESSAGE_MAX = 400;
function subagentFinishedEvent(target, input) {
  const metadata = {
...
// src/agent/claude-code/hooks/SubagentStop.ts
await runHook("SubagentStop", {
  parse: readSubagentStop,
  handler: async (payload) => {
    const agentId = payload.agentId;
    if (agentId === void 0) return;
    const parent = await ensureClaudeSession(payload.sessionId, void 0, {
    ...
    if (child !== void 0) {
      await captureTranscriptCommentary(payload, child, (events) => onLifecycleEvent(claudeRuntime.ingest, events));
    }
    ...
    if (child !== void 0) {
      await onSessionEnd(claudeRuntime.session, {
        ...
        ...child.turnId !== void 0 ? { turnId: child.turnId } : {},
