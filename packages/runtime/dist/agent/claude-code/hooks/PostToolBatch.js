...
function readPostToolBatch(raw) {
...
function toolBatchEvent(target, toolNames) {
  const body = toolNames.length > 0 ? `Tools: ${toolNames.join(", ")}` : `Batch of ${toolNames.length} tool calls`;
...
// src/agent/claude-code/hooks/PostToolBatch.ts
