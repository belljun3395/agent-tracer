...
function onBindingRelease(hook, runtimeSource, runtimeSessionId) {
  return hook.releaseBinding.execute(runtimeSource, runtimeSessionId);
}

// src/agent/claude-code/hooks/SessionEnd.ts
