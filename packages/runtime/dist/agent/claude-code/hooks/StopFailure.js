...
function turnFailedEvent(target, input) {
  const metadata = {
...
// src/agent/claude-code/hooks/StopFailure.ts
  ...
  handler: async (payload) => {
    ...
    await onLifecycleEvent(claudeRuntime.ingest, [
      turnFailedEvent(target, {
        ...
        ...payload.errorMessage !== void 0 ? { errorMessage: payload.errorMessage } : {},
