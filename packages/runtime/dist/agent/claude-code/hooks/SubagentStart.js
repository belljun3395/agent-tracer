...
function readSubagentStart(raw) {
...
function subagentStartedEvent(target, input) {
  const metadata = {
    ...
    ...input.childTaskId !== void 0 ? { childTaskId: input.childTaskId } : {}
  };
  return {
...
// src/agent/claude-code/hooks/SubagentStart.ts
