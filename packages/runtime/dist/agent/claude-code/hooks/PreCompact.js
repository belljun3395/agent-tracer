...
function compactStartedEvent(target, trigger, customInstructions) {
...
// src/agent/claude-code/hooks/PreCompact.ts
await runHook("PreCompact", {
  ...
  handler: async (payload) => {
    ...
    await onLifecycleEvent(claudeRuntime.ingest, [
      compactStartedEvent(target, payload.trigger, instructions || void 0)
    ]);
  }
});
