...
function notificationEvent(target, notificationType, message) {
...
// src/agent/claude-code/hooks/Notification.ts
await runHook("Notification", {
  parse: readNotification,
  handler: async (payload) => {
    const target = payload.agentId !== void 0 ? await ensureSubagentSession(payload.sessionId, payload.agentId, payload.agentType) : await ensureClaudeSession(payload.sessionId, void 0, { resume: false });
