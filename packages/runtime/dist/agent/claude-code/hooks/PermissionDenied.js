...
function readPermissionDenied(raw) {
...
var INPUT_SUMMARY_MAX = 400;
function permissionDeniedEvent(target, toolName, toolInput, toolUseId) {
  const metadata = {
...
// src/agent/claude-code/hooks/PermissionDenied.ts
