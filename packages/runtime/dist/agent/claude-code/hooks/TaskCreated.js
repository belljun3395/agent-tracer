...
function readTaskLifecycle(raw) {
...
function todoLifecycleEvent(target, input) {
  const metadata = {
...
// src/agent/claude-code/hooks/TaskCreated.ts
  ...
  handler: async (payload) => {
    ...
    await onLifecycleEvent(claudeRuntime.ingest, [
      todoLifecycleEvent(target, {
        ...
        source: "TaskCreated",
        status: "pending",
        ...payload.taskDescription !== void 0 ? { body: payload.taskDescription } : {}
      })
    ]);
  }
});
