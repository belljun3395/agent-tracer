...
// src/claude-code/hooks/PreToolUse.ts
await runHook("PreToolUse", {
  ...
  handler: async (payload) => {
    ...
    if (!toolName) return;
    const command = toolName === "Bash" || toolName === "PowerShell" ? toStringField(payload.toolInput, "command") : void 0;
    const questions = toolName === "AskUserQuestion" ? extractQuestions(payload.toolInput) : void 0;
...
function toStringField(input, key) {
