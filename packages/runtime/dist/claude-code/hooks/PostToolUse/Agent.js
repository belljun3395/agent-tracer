...
// src/claude-code/hooks/PostToolUse/_agent.ops.ts
function extractChildSessionId(toolResponse) {
...
async function postAgentEvent({ payload, ids }) {
  ...
  const semantic = inferAgentSemantic(agentName || void 0, "Agent");
...
// src/claude-code/hooks/PostToolUse/Agent.ts
