...
// src/claude-code/hooks/PostToolUse/_skill.ops.ts
async function postSkillEvent({ payload, ids }) {
  ...
  await postTaggedEvent2({
    ...
    ...toTrimmedString(payload.toolInput["args"]) ? { body: `args: ${toTrimmedString(payload.toolInput["args"], 400)}` } : {},
    metadata
  });
}

// src/claude-code/hooks/PostToolUse/Skill.ts
