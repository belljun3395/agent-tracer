...
function uuidFromSeed(seed) {
  const hash = crypto2.createHash("sha1").update(UUID_NAMESPACE).update("\0").update(seed).digest();
...
function readTaskCompleted(raw) {
...
// src/claude-code/hooks/TaskCompleted.ts
