...
export function toIngestEvent(event: RuntimeIngestEvent, occurredAt: string): IngestEvent {
...
export function toRunIngestEvent(input: RunEventInput, occurredAt: string): IngestEvent {
    return {
        id: generateUlid(),
        kind: input.kind,
        taskId: input.taskId,
