...
import type { ITimelineEventProjection } from "@monitor/activity-api/event/public/iservice/timeline.event.projection.iservice.js";
import { TIMELINE_EVENT_PROJECTION } from "@monitor/activity-api/event/public/tokens.js";
import type {
