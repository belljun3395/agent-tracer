import { KIND, LANE } from "@monitor/activity-api/event/public/types/event.const.js";
import type { EventRecordingInput } from "@monitor/activity-api/event/public/types/event.types.js";
