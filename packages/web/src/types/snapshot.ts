 ...
 */
function collectKeyFiles(events: readonly TimelineEventRecord[], modifiedFiles: readonly string[]): readonly string[] {
 ...
 */
function describeDecisionEvent(event: TimelineEventRecord): string | null {
 ...
 */
function collectOpenTodoTitles(events: readonly TimelineEventRecord[]): readonly string[] {
 ...
 */
function collectOpenQuestionTitles(events: readonly TimelineEventRecord[]): readonly string[] {
 ...
 */
function stringArrayMetadata(event: TimelineEventRecord, key: string): readonly string[] {
    const value = event.metadata[key];
