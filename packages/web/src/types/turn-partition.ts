...
/**
 * Ordered, gap-free partition of a task's non-prelude turns. See server-side
 * counterpart at packages/server/src/domain/workflow/turn.partition.ts — kept in
 * sync intentionally until a shared package lands.
 */
