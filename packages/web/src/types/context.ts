...
import type { ReusableTaskSnapshot, WorkflowEvaluationData } from "./workflow.js";
 ...
 */
export function buildWorkflowContext(events: readonly TimelineEventRecord[], taskTitle: string, evaluation?: Partial<WorkflowEvaluationData> | null, snapshotOverride?: ReusableTaskSnapshot | null): string {
 ...
 */
export function buildPlanSection(events: readonly TimelineEventRecord[]): string | undefined {
 ...
 */
export function buildLaneSections(events: readonly TimelineEventRecord[]): readonly string[] {
    const sections: string[] = [];
 ...
 */
export function buildModifiedFilesSection(events: readonly TimelineEventRecord[]): string | undefined {
 ...
 */
export function buildOpenTodoSection(events: readonly TimelineEventRecord[]): string | undefined {
    ...
    for (const event of openTodos) {
        latestTodoByTitle.set(event.title, (event.metadata["todoState"] as string | undefined) ?? "added");
    }
 ...
 */
export function buildVerificationSummarySection(events: readonly TimelineEventRecord[]): string | undefined {
 ...
 */
function describeWorkflowEvent(event: TimelineEventRecord): string | null {
 ...
 */
function shouldPreferDetailOnly(event: TimelineEventRecord, title: string): boolean {
