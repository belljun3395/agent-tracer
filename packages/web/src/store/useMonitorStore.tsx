...
function buildComposedState(taskSlice: TaskStoreSlice, eventSlice: EventStoreSlice, wsSlice: WebSocketStoreSlice): MonitorState {
...
export function MonitorProvider({ children }: {
    ...
    React.useEffect(() => {
        if (taskState.isEditingTaskTitle)
            return;
