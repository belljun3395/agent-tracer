...
import { FULL_TIMELINE_LANE_FILTERS, buildFilteredTimeline, buildSelectedConnector, buildTaskWorkspaceSelection, parseConnectorKey, type TimelineEventRecord } from "../../types.js";

type EventOverrides = Omit<Partial<TimelineEventRecord>, "id" | "taskId"> & {
    id?: TimelineEventRecord["id"] | string;
    taskId?: TimelineEventRecord["taskId"] | string;
};
