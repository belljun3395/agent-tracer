/** 행에서 수행하는 동작을 나타내는 24x24 단일 stroke SVG 아이콘이다. */
...
export function UnarchiveIcon({ size = 12, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** 에이전트 잡 탭에서 쓰는 activity pulse 글리프. */
...
/** 인라인 "rename" 조작에 쓰는 밑줄 없는 연필 글리프. */

export function PencilSimpleIcon({ size = 14, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CopyIcon({ size = 11, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
