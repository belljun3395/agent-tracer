/**
 * 관찰가능성 섹션 컴포넌트 — trace link, action registry 지표, 메트릭 그리드 등.
 */
...
// ---------------------------------------------------------------------------
// Observability format helpers
// ---------------------------------------------------------------------------

export function formatTraceLinkCoverageNote(
  observability: TaskObservabilityResponse["observability"]
): string {
...
export function formatTraceLinkHealthNote(
  observability: TaskObservabilityResponse["observability"]
): string {
  if (observability.traceLinkEligibleEventCount === 0) {
...
export function formatActionRegistryGapNote(
  observability: TaskObservabilityResponse["observability"]
): string {
...
// ---------------------------------------------------------------------------
// Observability metric components
// ---------------------------------------------------------------------------

export function ObservabilityMetricGrid({
  items
}: {
...
export function ObservabilityPhaseBreakdown({
  phases
}: {
