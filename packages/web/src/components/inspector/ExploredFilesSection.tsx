...
export function sortExploredFiles(
  files: readonly ExploredFileStat[],
  key: ExplorationSortKey
...
/** ExploredFilesSection: 탐색된 파일 목록을 접기/펼치기로 표시. compact 관계와 읽기 시간 이력 포함. */
export function ExploredFilesSection({
