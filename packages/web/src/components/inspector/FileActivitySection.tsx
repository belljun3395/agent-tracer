/**
 * 파일 활동(read + write) 섹션 — 접기/펼치기 + 정렬 기능 포함.
 */

import type React from "react";
import { cn } from "../../lib/ui/cn.js";
import type { FileActivityStat } from "../../lib/insights.js";
...
export function sortFileActivity(
  files: readonly FileActivityStat[],
  key: FileSortKey
...
/** FileActivitySection: 실제 파일 활동(read + write) 목록 카드. */
export function FileActivitySection({
