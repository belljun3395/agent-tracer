/**
 * todo.logged 이벤트를 todoId 기준으로 그룹화해 상태 전이 목록을 표시하는 섹션.
 */
...
/** TodoGroupSection: todo.logged 이벤트를 todoId 기준으로 그룹화해 상태 전이 목록을 표시. */
export function TodoGroupSection({ group }: { readonly group: TodoGroup }): React.JSX.Element {
  return (
