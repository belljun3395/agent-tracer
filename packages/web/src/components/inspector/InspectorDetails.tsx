...
export function DetailTaskModel({ summary }: {
    ...
    if (entries.length === 0)
        return null;
    return (<SectionCard title="AI Model" helpText={inspectorHelpText.aiModel} bodyClassName="pt-4">
...
export function DetailSkillListing({ event }: {
    ...
    return (<SectionCard title="Skill listing" helpText={inspectorHelpText.skillListing} bodyClassName="pt-4">
...
export function DetailNestedMemory({ event }: {
    ...
    return (<SectionCard title="Nested memory" helpText={inspectorHelpText.contextSaved} bodyClassName="pt-4">
      <div className="mb-2 flex flex-wrap items-center gap-2">
