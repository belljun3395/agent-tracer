...
describe("workflow snapshot draft conversion", () => {
  it("round-trips snapshot values through the editable draft shape", () => {
    const snapshot = {
      ...
      evidenceSummary: "Evidence: 4 events (2 proven, 2 self-reported)",
      ruleAuditSummary: "Rule audit: 1 events (1 pass/fix)",
      ruleEnforcementSummary: "Rule enforcement: 1 decisions (1 approved)",
