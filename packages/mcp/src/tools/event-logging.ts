/**
 * @module tools/event-logging
 *
 * Event logging tool registrations.
 * Records various agent activities including tool usage, planning, exploration, questions, todos, and verification.
 */
...
/**
 * Register event logging tools.
 * Includes: monitor_tool_used, monitor_terminal_command, monitor_save_context,
