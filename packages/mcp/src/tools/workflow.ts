 ...
 *
 * Workflow library tool registrations.
 * Manages task evaluation and similar workflow discovery for learning from past work.
 */
 ...
 * Includes: monitor_evaluate_task, monitor_find_similar_workflows
 */
