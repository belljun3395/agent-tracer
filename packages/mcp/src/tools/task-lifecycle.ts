/**
 * @module tools/task-lifecycle
 *
 * Task lifecycle tool registrations.
 * Manages core task creation, completion, linking, error handling, and runtime session lifecycle.
 */
 ...
 * Includes: monitor_task_start, monitor_task_complete, monitor_task_link,
