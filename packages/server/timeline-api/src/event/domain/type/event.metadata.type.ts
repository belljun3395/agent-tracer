import type {
    EventSubtypeGroup,
    EventToolFamily,
} from "@monitor/timeline-api/event/domain/runtime/const/event.subtype.keys.const.js";
import type { AllEventSubtypeKey } from "@monitor/timeline-api/event/domain/common/const/subtype.registry.const.js";
import type { TodoState } from "@monitor/timeline-api/event/domain/common/const/event.kind.const.js";
import type { EvidenceLevel } from "@monitor/timeline-api/event/domain/common/const/event.meta.const.js";
