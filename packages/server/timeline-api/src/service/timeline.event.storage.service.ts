...
import { LANE, type MonitoringEventKind } from "@monitor/timeline-api/domain/common/const/event.kind.const.js";
import { normalizeLane } from "@monitor/timeline-api/domain/event.lane.policy.js";
