...
import { LANE, type MonitoringEventKind } from "@monitor/timeline-api/domain/event/common/const/event.kind.const.js";
import { normalizeLane } from "@monitor/timeline-api/domain/event/event.lane.policy.js";
