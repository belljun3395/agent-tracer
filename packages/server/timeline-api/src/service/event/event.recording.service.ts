...
import { createEventRecordDraft, normalizeFilePaths, deriveFileChangeEventInputs } from "@monitor/timeline-api/domain/event/event.recording.policy.js";
...
import type { EventRecordingIn, EventRecordingOut } from "@monitor/timeline-api/application/event/dto/event.recording.dto.js";
