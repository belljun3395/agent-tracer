import type {
    EventSubtypeGroup,
    EventToolFamily,
} from "@monitor/timeline-api/domain/event/runtime/const/event.subtype.keys.const.js";
import type { AllEventSubtypeKey } from "@monitor/timeline-api/domain/event/common/const/subtype.registry.const.js";
import type { TodoState } from "@monitor/timeline-api/domain/event/common/const/event.kind.const.js";
import type { EvidenceLevel } from "@monitor/timeline-api/domain/event/common/const/event.meta.const.js";
