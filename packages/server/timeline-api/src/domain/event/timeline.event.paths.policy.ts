import { normalizeFilePath } from "@monitor/timeline-api/domain/event/paths.js";
import { isUserMessageEvent } from "@monitor/timeline-api/domain/event/event.predicates.policy.js";
import { commandTargetPath, flattenCommandSteps } from "@monitor/timeline-api/domain/event/command.analysis.policy.js";
import type { CommandTargetLike } from "@monitor/timeline-api/domain/event/command.analysis.policy.js";
import { META } from "@monitor/timeline-api/domain/event/runtime/const/metadata.keys.const.js";
import { readStringArray } from "@monitor/timeline-api/domain/event/event.metadata.policy.js";
import type { TimelineEvent } from "@monitor/timeline-api/domain/event/type/timeline.event.type.js";
import type { TimelineEventPaths } from "@monitor/timeline-api/domain/event/type/timeline.event.paths.type.js";
