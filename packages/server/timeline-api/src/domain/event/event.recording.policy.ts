...
import { isBackgroundLane, isExplorationLane } from "@monitor/timeline-api/domain/event/event.predicates.policy.js";
import { KIND } from "@monitor/timeline-api/domain/event/common/const/event.kind.const.js";
import type { EventRecordingInput, EventRecordDraft } from "@monitor/timeline-api/domain/event/type/event.recording.type.js";
import type { EventClassification } from "@monitor/timeline-api/domain/event/type/timeline.event.type.js";
