import type {
    ...
    MonitoringEventKind,
    TimelineLane,
} from "@monitor/timeline-api/domain/common/const/event.kind.const.js";
import type { EventRelationType } from "@monitor/timeline-api/domain/common/const/event.meta.const.js";
...
export { EVENT_RELATION_TYPES } from "@monitor/timeline-api/domain/common/const/event.meta.const.js";
