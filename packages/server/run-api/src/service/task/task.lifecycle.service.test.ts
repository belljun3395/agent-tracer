...
import type { SessionRepository } from "../../repository/session/session.repository.js";
import type { SessionSnapshot } from "@monitor/run-api/domain/session/dto/session.snapshot.dto.js";
import type {
    ITimelineEventWrite,
    TimelineEventWriteInput,
} from "@monitor/timeline-api/public/event/iservice/timeline.event.write.iservice.js";
...
function makeSessionAccess(): SessionRepository & {
