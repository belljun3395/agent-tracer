...
import type { TaskAccessPublicAdapter } from "@monitor/run-api/adapter/task/task.access.public.adapter.js";
...
import type { TurnPartitionRepository } from "../../repository/turn/turn.partition.repository.js";
...
function setup(opts: { taskFound?: boolean; events?: TimelineEvent[]; stored?: ReturnType<TurnPartitionRepository["get"]> extends Promise<infer T> ? T : never } = {}) {
    ...
    } as unknown as TaskAccessPublicAdapter & { findById: Mock };
    const events = {
