import { normalizeOutputLanguage, type OutputLanguage } from "@monitor/shared/llm/output.language.js";
...
export function normalizeRecipeLanguage(raw: string | null): OutputLanguage {
