...
import { z } from "zod";
import { RULE_EXPECTED_ACTIONS, RULE_SCOPES, RULE_SEVERITIES, RULE_TRIGGER_SOURCES } from "../../domain/rule/const/rule.const.js";
import { checkRuleInvariants } from "../../domain/rule/rule.invariants.policy.js";
import type { RuleExpectation } from "../../domain/rule/type/rule.expectation.type.js";
