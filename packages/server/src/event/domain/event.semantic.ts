import {
    ...
    SUBTYPE_REGISTRY,
} from "~event/domain/common/subtype.registry.js";
...
} from "~event/domain/runtime/event.subtype.keys.js";
import type { EventSubtypeGroup } from "~event/domain/runtime/type/event.subtype.keys.type.js";
