import type { MonitoringTask } from "./model/task.model.js";
import { isInternalEvent, isTaskLifecycleEvent, isUserLane } from "../event/event.predicates.js";
import type { TimelineEvent } from "../event/model/timeline.event.model.js";
import {
    GENERIC_TASK_TITLE_PREFIXES,
    GENERIC_TASK_TITLE_PREFIX_SPLIT_PATTERN,
    MAX_TASK_TITLE_LENGTH,
    TRAILING_SESSION_SUFFIX_PATTERN,
} from "./const/task.display-title.const.js";
