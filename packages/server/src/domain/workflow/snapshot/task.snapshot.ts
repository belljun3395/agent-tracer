...
import type {
    ...
    ReusableTaskSnapshotInput,
} from "./model/task.snapshot.model.js";

/**
 * Distills a raw event timeline into the reusable snapshot stored with evaluations and previews.
 */
export function createReusableTaskSnapshot({ objective, events, evaluation }: ReusableTaskSnapshotInput): ReusableTaskSnapshot {
 ...
 */
function composeSearchText(input: {
