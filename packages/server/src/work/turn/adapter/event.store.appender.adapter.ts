...
import type { IDomainEventAppender } from "~activity/event/public/iservice/domain.event.appender.iservice.js";
import { DOMAIN_EVENT_APPENDER } from "~activity/event/public/tokens.js";
import type {
    IEventStoreAppender,
