/**
 * @module infrastructure/sqlite/sqlite-search-documents
 *
 * 전역 검색용 search_documents 인덱스 유틸리티.
 */
...
function joinSearchTextParts(parts: readonly Array<string | null | undefined>): string {
  return parts
...
function flattenSearchableMetadata(
...
function collectMetadataFragments(
  value: unknown,
  fragments: string[],
  limit: number
): void {
