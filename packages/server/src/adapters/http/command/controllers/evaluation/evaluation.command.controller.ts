...
export class TaskEvaluationCommandController {
    constructor(
    ...
    async upsertEvaluation(
        ...
        await this.upsertTaskEvaluation.execute(buildEvaluationInput(taskId, scopeKey, body));
...
function buildEvaluationInput(
    ...
    body: Omit<UpsertTaskEvaluationUseCaseIn, "taskId" | "scopeKey">,
): UpsertTaskEvaluationUseCaseIn {
    return {
        taskId,
        ...(scopeKey ? { scopeKey } : {}),
        rating: body.rating,
