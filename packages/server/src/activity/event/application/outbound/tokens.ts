...
export const POST_PROCESSING_QUEUE_PORT = "EVENT_POST_PROCESSING_QUEUE_PORT";
export const CLOCK_PORT = "EVENT_CLOCK_PORT";
export const ID_GENERATOR_PORT = "EVENT_ID_GENERATOR_PORT";
