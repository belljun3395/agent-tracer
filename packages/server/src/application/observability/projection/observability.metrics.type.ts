import type { EvidenceLevel, MonitoringPhase, MonitoringPhaseBucket } from "~domain/monitoring/index.js";

export type ObservabilityPhase = MonitoringPhase;
export type ObservabilityPhaseBucket = MonitoringPhaseBucket;
