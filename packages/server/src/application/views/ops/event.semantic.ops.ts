import {
    ...
    readString,
    SUBTYPE_REGISTRY,
    type AllEventSubtypeKey,
    type EventSemanticMetadata,
    type EventSubtypeGroup,
    type TimelineEvent,
} from "~domain/index.js";
import type { EventSemanticView } from "../event.semantic.type.js";

export type * from "../event.semantic.type.js";

export function resolveSemanticView(event: TimelineEvent): EventSemanticView | undefined {
