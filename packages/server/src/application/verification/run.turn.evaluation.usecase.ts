...
import type { TurnEvaluationService } from "./services/turn.evaluation.service.js";
...
export class RunTurnEvaluationUseCase {
    ...
    async execute(input: RunTurnEvaluationUseCaseIn): Promise<RunTurnEvaluationUseCaseOut> {
