import { AgentExecutionFailure, isNonRetryableSubtype } from "~ai-agent-worker/support/llm/agent.error.js";
...
const NON_RETRYABLE_ERRORS = [MissingApiKeyError, JobNotFoundError, JobAlreadySettledError] as const;
