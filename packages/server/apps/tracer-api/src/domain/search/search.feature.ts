...
import { OpenSearchMemoSearch } from "~tracer-api/domain/search/adapter/opensearch.memo.search.js";
...
import { MEMO_SEARCH } from "~tracer-api/domain/search/port/memo.search.port.js";
...
export const searchFeature = {
    ...
    providers: [
        ...
        OpenSearchMemoSearch,
        { provide: MEMO_SEARCH, useExisting: OpenSearchMemoSearch },
    ],
};
