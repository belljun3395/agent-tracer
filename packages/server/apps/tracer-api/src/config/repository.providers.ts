...
export const repositoryProviders: Provider[] = [
    ...
    { provide: FileAffinityRepository, inject: [TRACER_DATA_SOURCE], useFactory: (ds: DataSource) => new FileAffinityRepository(ds.getRepository(FileAffinityEntity)) },
    ...
    { provide: JobFeedbackRepository, inject: [TRACER_DATA_SOURCE], useFactory: (ds: DataSource) => new JobFeedbackRepository(ds.getRepository(JobFeedbackEntity)) },
