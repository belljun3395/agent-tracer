import { SessionId, createTaskSlug, normalizeWorkspacePath, TaskId, type EventId, type MonitoringEventKind, type MonitoringTask, type SessionId as MonitorSessionId, type TaskId as MonitorTaskId, } from "@monitor/domain";
