import { tokenizeActionName } from "@monitor/classification";
import type { AgentActivityType } from "@monitor/domain";
import type { GenericEventInput, TraceActivityInput, TraceRelationInput } from "../types.js";
import { extractMetadataBoolean, extractMetadataString, extractMetadataStringArray, normalizeTagSegment } from "./trace-metadata-factory.helpers.js";
export class TraceMetadataFactory {
    static build(metadata: Record<string, unknown> | undefined, input: {
        readonly metadata?: Record<string, unknown>;
    } & Partial<TraceActivityInput & TraceRelationInput>): Record<string, unknown> {
        return {
            ...(metadata ?? {}),
