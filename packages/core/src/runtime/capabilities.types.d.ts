...
export declare const RuntimeAdapterId: (value: string) => RuntimeAdapterId;
export declare const CLAUDE_PLUGIN_ADAPTER_ID: RuntimeAdapterId;
export type EvidenceStrength = "proven" | "inferred" | "self_reported" | "unavailable";
export type RuntimeEvidenceFeatureId = "raw_user_prompt" | "assistant_response" | "exploration_activity" | "tool_activity" | "mcp_coordination" | "subagents_background";
