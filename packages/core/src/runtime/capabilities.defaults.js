...
import { CLAUDE_PLUGIN_ADAPTER_ID } from "./capabilities.types.js";
const DEFAULT_ADAPTERS = [
    {
        ...
        evidenceProfile: {
            ...
            summary: "Claude plugin hooks provide mechanically observed prompts, tool usage, MCP coordination, subagent lifecycle, and assistant responses.",
            features: [
                {
                    id: "raw_user_prompt",
 ...
 */
export function registerDefaultRuntimeAdapters() {
...
export const RUNTIME_ADAPTER_IDS = DEFAULT_ADAPTERS.map((adapter) => adapter.adapterId);
//# sourceMappingURL=capabilities.defaults.js.map