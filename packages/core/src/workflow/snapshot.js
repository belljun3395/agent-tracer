 ...
 */
export function buildReusableTaskSnapshot({ objective, events, evaluation }) {
 ...
 */
function findFirstBody(events, kind) {
 ...
 */
function inferOutcomeSummary(events, modifiedFiles, verificationSummary) {
 ...
 */
function collectModifiedFiles(events) {
 ...
 */
function collectKeyFiles(events, modifiedFiles) {
 ...
 */
function collectVerificationState(events) {
 ...
 */
function collectDecisionLines(events) {
 ...
 */
function describeDecisionEvent(event) {
 ...
 */
function collectNextSteps(events) {
 ...
 */
function collectOpenTodoTitles(events) {
 ...
 */
function collectOpenQuestionTitles(events) {
 ...
 */
function numericMetadata(event, key) {
    const value = event.metadata[key];
 ...
 */
function stringArrayMetadata(event, key) {
    const value = event.metadata[key];
