...
import { resolveSemanticView } from "@monitor/activity/event/domain/event.semantic.js";
import { resolveTimelineEventPaths } from "@monitor/activity/event/domain/timeline.event.paths.js";
