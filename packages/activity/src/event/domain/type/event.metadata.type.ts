import type {
    EventSubtypeGroup,
    EventToolFamily,
} from "@monitor/activity/event/domain/runtime/const/event.subtype.keys.const.js";
import type { AllEventSubtypeKey } from "@monitor/activity/event/domain/common/const/subtype.registry.const.js";
import type { TodoState } from "@monitor/activity/event/domain/common/const/event.kind.const.js";
import type { EvidenceLevel } from "@monitor/activity/event/domain/common/const/event.meta.const.js";
