...
import type {
    IVerdictRepository,
    VerdictUpsertInput,
} from "@monitor/governance-api/verification/application/outbound/verdict.repository.port.js";
import type { TurnVerdict, VerdictStatus } from "@monitor/governance-api/verification/domain/model/verdict.model.js";
